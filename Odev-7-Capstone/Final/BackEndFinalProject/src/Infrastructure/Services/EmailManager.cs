...
namespace Infrastructure.Services
{
    public class EmailManager : IEmailService
    {
        ...
        private async Task Send(SendEmailDto sendEmailDto)
        {
            ...
            message.From = new MailAddress("noreply.upschoolhomework@gmail.com");
                ...
                using (var workbook = new XLWorkbook(excelFilePath))
                {
                    ...
                    using (var fileStream = new FileStream(excelFilePath, FileMode.Open, FileAccess.Read))
                    {
                        ...
                        using (var smtpclient = new SmtpClient())
                        {
                            ...
                            smtpclient.Credentials = new NetworkCredential("noreply.upschoolhomework@gmail.com", "chvnwpprkwasasjm");
            ...
            else
            {
                ...
                client.Credentials = new NetworkCredential("noreply.upschoolhomework@gmail.com", "chvnwpprkwasasjm");
