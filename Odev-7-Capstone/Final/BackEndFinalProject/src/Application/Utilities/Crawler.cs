    ...
    public class Crawler
    {
        ...
        public async Task<OrderDto> OrderResults(CrawlOrderDto _crawlOrderDto)
        {
            var crawlOrderDto = new CrawlOrderDto 
            {
                ...
                IsAmountEntered = _crawlOrderDto.IsAmountEntered,
                RequestedAmount = _crawlOrderDto.RequestedAmount,
                IsDownloadChecked = _crawlOrderDto.IsDownloadChecked,
                IsEmailChecked = _crawlOrderDto.IsEmailChecked,
                Email = _crawlOrderDto.Email,
            };
            ...
            if (crawlOrderDto.IsAmountEntered == true)
            {
            ...
            while (foundProductCount < requestedAmount)
            {
                ...
                foreach (IWebElement p in products)
                {
                    ...
                    imageUrl = imageUrl.Replace("https://4teker.net/productPics/", "");
